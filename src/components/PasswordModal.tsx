      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="bottom-0 sm:bottom-6 left-0 right-0 sm:left-1/2 sm:-translate-x-1/2 z-[6001] fixed flex flex-col bg-white shadow-2xl border border-black/5 rounded-t-[48px] sm:rounded-[48px] w-full sm:w-[450px] max-h-[92vh] sm:max-h-[95vh] overflow-hidden pb-[env(safe-area-inset-bottom)]"
          >
            {/* Handle */}
