      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="bottom-[6px] sm:bottom-0 left-1/2 -translate-x-1/2 z-[6001] fixed flex flex-col bg-white shadow-2xl border border-black/5 rounded-[40px] sm:rounded-b-none w-[calc(100%-12px)] sm:w-[450px] max-h-[92vh] sm:max-h-[95vh] overflow-hidden"
          >
            {/* Handle */}
