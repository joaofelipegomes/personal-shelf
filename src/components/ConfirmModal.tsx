      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-[max(0.75rem,env(safe-area-inset-bottom))] sm:bottom-0 left-1/2 -translate-x-1/2 w-[calc(100%-24px)] sm:w-[450px] bg-white rounded-[48px] sm:rounded-b-none p-8 pt-2 shadow-2xl border border-black/5 z-[4001] text-center"
          >
            {/* Apple Sheet Handle */}
