      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-3 left-2.5 right-2.5 sm:bottom-0 sm:left-1/2 sm:right-auto sm:-translate-x-1/2 w-auto sm:w-[450px] bg-white rounded-t-[32px] rounded-b-[48px] sm:rounded-t-[48px] sm:rounded-b-none p-8 pt-2 shadow-2xl border border-black/5 z-[4001] text-center"
          >
            {/* Apple Sheet Handle */}
